    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ServiceProviderDetails userProfile = snapshot.getValue(ServiceProviderDetails.class);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(ServiceProviderProfile.this, "Something Wrong!", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ServiceProviderProfile.super.onBackPressed();
                finish();
            }
        });
    }
