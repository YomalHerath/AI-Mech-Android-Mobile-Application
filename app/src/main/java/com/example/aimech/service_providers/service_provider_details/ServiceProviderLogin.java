...
public class ServiceProviderLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(ServiceProviderLogin.this);
                    ...
                    .addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (usertype == 1) {
                                ...
                                Toast.makeText(ServiceProviderLogin.this, "Your account type is incorrect", Toast.LENGTH_SHORT).show();
                            }
                        }
        ...
        sign_up.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), ServiceProviderRegister.class));
                finish();
            }
        });
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ServiceProviderLogin.super.onBackPressed();
            }
        });
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                if (user.isEmailVerified()) {
                                    ...
                                    firebaseDatabase.getReference().child("Users").child(userID).child("user_type")
                                            .addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                    ...
                                                    if (usertype == 1) {
                                                        Toast.makeText(ServiceProviderLogin.this, "Login Successful", Toast.LENGTH_LONG).show();
                                    ...
                                    Toast.makeText(ServiceProviderLogin.this, "Check your email to verify your account", Toast.LENGTH_LONG).show();
                                }
                            ...
                            //login failed
                                ...
                                progressDialog.dismiss();
                                Toast.makeText(ServiceProviderLogin.this, "Logging Failed" + task.getException().getMessage(), Toast.LENGTH_LONG).show();
                            }
                        }
                    });
                }
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        auth.sendPasswordResetEmail(mail).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(ServiceProviderLogin.this, "Reset Link sent to your mail", Toast.LENGTH_LONG).show();
                            }
                        }).addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(ServiceProviderLogin.this, "Error ! Rest Link Not Sent " + e.getMessage(), Toast.LENGTH_LONG).show();
                            }
                        });
                    }
                });
