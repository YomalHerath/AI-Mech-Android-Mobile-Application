...
import com.example.aimech.service_providers.service_center.AddMechanicDetails;
import com.example.aimech.service_providers.service_center.ServiceCenterList;
...
public class ServiceProviderDashboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profile_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ServiceProviderDashboard.this, ServiceProviderProfile.class);
    ...
    public void add_service_provider(View view) {
        startActivity(new Intent(getApplicationContext(), AddMechanicDetails.class));
    }
    ...
    public void update_service_provider(View view) {
