...
public class UserRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reg_full_name = findViewById(R.id.reg_full_name_ed);
        reg_username = findViewById(R.id.reg_username_ed);
        reg_email = findViewById(R.id.reg_email_ed);
        reg_mobile_no = findViewById(R.id.reg_mobile_ed);
        reg_password = findViewById(R.id.reg_password_ed);
        reg_confirm_password = findViewById(R.id.reg_confirm_pass_ed);
    ...
    public void registerUser() {
        ...
        progressDialog.setTitle("User registration is in progress");
        progressDialog.show();

        //set firebase authentication to the registering user
        auth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    FirebaseUser user;//create object of firebase user
                    ...
                    UserDetails helperClass = new UserDetails(uid, full_name, username, email, phone_no, 0);
                    ...
                    FirebaseDatabase.getInstance().getReference("Users")
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(UserRegister.this, "Your Account has been created successfully", Toast.LENGTH_LONG).show();
                            ...
                            //register fail in saving data in realtime database
                                ...
                                Toast.makeText(UserRegister.this, "Failed Registration! " + task.getException().getMessage(), Toast.LENGTH_LONG).show();
                            }
                        }
                    });
                }
