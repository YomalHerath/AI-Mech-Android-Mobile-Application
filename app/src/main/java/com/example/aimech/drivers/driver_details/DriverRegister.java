...
public class DriverRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DriverRegister.super.onBackPressed();
            }
        });
        ...
        auth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    DriverDetails helperClass = new DriverDetails(uid, full_name, username, email, phone_no, 2);
                    ...
                    FirebaseDatabase.getInstance().getReference("Users")
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(DriverRegister.this, "Your Account has been created successfully", Toast.LENGTH_LONG).show();
                            ...
                            //register fail in saving data in realtime database
                                ...
                                Toast.makeText(DriverRegister.this, "Failed Registration! " + task.getException().getMessage(), Toast.LENGTH_LONG).show();
                            }
                        }
                    });
                }
