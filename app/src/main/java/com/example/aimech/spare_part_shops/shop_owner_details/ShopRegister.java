...
public class ShopRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(ShopRegister.this);
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShopRegister.super.onBackPressed();
                finish();
            }
        });
    ...
    public void registerUser() {
        ...
        progressDialog.setTitle("Driver registration is in progress");
        progressDialog.show();
        ...
        auth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    ShopDetails helperClass = new ShopDetails(uid, full_name, username, email, phone_no, 3);
                    ...
                    FirebaseDatabase.getInstance().getReference("Users")
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(ShopRegister.this, "Your Account has been created successfully", Toast.LENGTH_LONG).show();
                            ...
                            //register fail in saving data in realtime database
                                ...
                                Toast.makeText(ShopRegister.this, "Failed Registration! " + task.getException().getMessage(), Toast.LENGTH_LONG).show();
                            }
                        }
                    });
                }
