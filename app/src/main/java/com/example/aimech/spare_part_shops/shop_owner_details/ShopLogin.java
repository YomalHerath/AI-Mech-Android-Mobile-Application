                    ...
                    .addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (usertype == 3) {
                                ...
                                Toast.makeText(ShopLogin.this, "Your account type is incorrect", Toast.LENGTH_SHORT).show();
                            }
                        }
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                if (user.isEmailVerified()) {
                                    ...
                                    firebaseDatabase.getReference().child("Users").child(userID).child("user_type")
                                            .addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                    ...
                                                    if (usertype == 3) {
                                                        Toast.makeText(ShopLogin.this, "Login Successful", Toast.LENGTH_LONG).show();
                                                        Intent intent = new Intent(getApplicationContext(), ShopDashboard.class);
                                                        startActivity(intent);
                                                        finish();
                                                    } else {
                                                        Toast.makeText(ShopLogin.this, "Login failed, your account type is incorrect", Toast.LENGTH_SHORT).show();
                                                    }
                                                }
                                    ...
                                    Toast.makeText(ShopLogin.this, "Check your email to verify your account", Toast.LENGTH_LONG).show();
                                }
                            ...
                            //login failed
                                ...
                                progressDialog.dismiss();
                                Toast.makeText(ShopLogin.this, "Logging Failed" + task.getException().getMessage(), Toast.LENGTH_LONG).show();
                            }
                        }
                    });
                }
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        auth.sendPasswordResetEmail(mail).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(ShopLogin.this, "Reset Link sent to your mail", Toast.LENGTH_LONG).show();
                            }
                        }).addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(ShopLogin.this, "Error ! Rest Link Not Sent " + e.getMessage(), Toast.LENGTH_LONG).show();
                            }
                        });
                    }
                });
